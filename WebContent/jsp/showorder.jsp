		...
		<div class="row">
			...
			<div class="col-md-4 col-md-offset-2">
				...
				<form action="controller" method="POST" class="form-horizontal">
					<input type="hidden" name="command" value="SHOWORDERBYNUMBER">
					<div class="form-group">
						<label for="order"><fmt:message key="button.show.one.order" /></label>
						<input name="order" id="order" type="text" class="form-control"
							placeholder="<fmt:message key="button.show.one.order.placeholder" />">
					</div>

					<button type="submit" class="btn btn-primary">
						<fmt:message key="button.show.one.order" />
					</button>
